package com.edu.gdmec.s07150825.mymediaplayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            if (!mPath.equals("")) {
                ...
                player.setDataSource(afd.getFileDescriptor(), afd.getStartOffset(), afd
                        .getDeclaredLength());
            }
        } catch (Exception e) {
            e.printStackTrace();
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (player.getDuration() > 0) {
                        progressValue = seekBar.getMax() * player.getCurrentPosition() / player
                                .getDuration();
                    }
